...
- Implement shapes:
  ...
  - Shape values: ~~Value definition~~, ~~substitution~~, ~~to string~~, ~~poem reading~~, ~~poem writing~~, ~~universe resolution~~, ~~value construction operations~~, ~~indirect property access~~, test example.
