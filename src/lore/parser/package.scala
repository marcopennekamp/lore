...
package object parser {
  ...
  /**
    ...
    */
  def xaryList[Operand, Result, _: P](op: String, part: => P[Operand], node: List[Operand] => Result): P[Result] = {
  ...
  /**
    ...
    */
  def xarySet[Operand, Result, _: P](op: String, part: => P[Operand], node: Set[Operand] => Result): P[Result] = {
    implicit val name: Name = Name(s"xary($op)")
