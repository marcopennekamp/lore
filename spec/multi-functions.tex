...
The second result is due to the fact that \type{Circle} and \type{+BoundingBox} are \textit{incomparable}, i.e. $\type{Circle} \incomparable \type{+BoundingBox}$, since the two types are neither equal, nor is one less or greater than the other.
