...
/**
  * A [[FunctionDefinition]] with a signature that has all of its type variables replaced with their type
  * assignments. Hence, a function instance represents a callable function whose type parameters are already
  * instanced.
  */
