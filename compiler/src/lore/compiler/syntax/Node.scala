...
object Node {
  ...
  /**
    ...
    */
  def withIndex[T1, R <: Node](construct: (T1, Position) => R)(args: (Index, T1))(implicit fragment: Fragment): R = {
    val (index, p1) = args
  ...
  /**
    * Construct a 1-element node with a position.
    */
  def withIndexUntupled[T1, R <: Node](construct: (T1, Position) => R)(index: Index, p1: T1)(implicit fragment: Fragment): R = {
    construct(p1, Position(fragment, index))
  }
  ...
  /**
    ...
    */
  def withIndex[T1, T2, R <: Node](construct: (T1, T2, Position) => R)(args: (Index, T1, T2))(implicit fragment: Fragment): R = {
  ...
  /**
    * Construct a 2-element node with a position.
    */
  def withIndexUntupled[T1, T2, R <: Node](construct: (T1, T2, Position) => R)(index: Index, p1: T1, p2: T2)(implicit fragment: Fragment): R = {
    construct(p1, p2, Position(fragment, index))
  }
  ...
  /**
    ...
    */
  def withIndex[T1, T2, T3, R <: Node](construct: (T1, T2, T3, Position) => R)(args: (Index, T1, T2, T3))(implicit fragment: Fragment): R = {
  ...
  /**
    ...
    */
  def withIndex[T1, T2, T3, T4, R <: Node](construct: (T1, T2, T3, T4, Position) => R)(args: (Index, T1, T2, T3, T4))(implicit fragment: Fragment): R = {
  ...
  /**
    ...
    */
  def withIndex[T1, T2, T3, T4, T5, R <: Node](
  ...
  /**
    ...
    */
  def withIndex[T1, T2, T3, T4, T5, T6, R <: Node](
  ...
  /**
    ...
    */
  def withIndex[T1, T2, T3, T4, T5, T6, T7, R <: Node](
