...
/**
  ...
  */
case class StructConstructorDefinition(struct: StructDefinition) extends Positioned with Variable {
  ...
  override lazy val asTargetVariable: Target.Variable = RuntimeNames.constructor(struct.tpe)
