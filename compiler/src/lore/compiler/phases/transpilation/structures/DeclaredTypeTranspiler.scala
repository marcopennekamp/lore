...
object DeclaredTypeTranspiler {
  ...
  /**
    ...
    */
  def transpile(tpe: DeclaredType)(implicit registry: Registry, symbolHistory: SymbolHistory): Vector[TargetStatement] = {
    tpe match {
  ...
  /**
    ...
    */
  def transpileDeferred(tpe: DeclaredType)(implicit registry: Registry, symbolHistory: SymbolHistory): Vector[TargetStatement] = {
    tpe match {
