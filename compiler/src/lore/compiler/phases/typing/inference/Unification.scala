...
import lore.compiler.phases.typing.inference.Inference.{Assignments, instantiate, instantiateByBound, isFullyInferred}
import lore.compiler.phases.typing.inference.InferenceBounds.{BoundType, narrowBound, narrowBounds, overrideBounds}
import lore.compiler.phases.typing.inference.InferenceVariable.{effectiveBounds, isDefined}
import lore.compiler.phases.typing.inference.TypeMatcher.{IncompatibleMatch, matchAll}
