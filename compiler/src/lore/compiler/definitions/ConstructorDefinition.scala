...
case class ConstructorDefinition(
  override val name: String, override val typeScope: TypeScope, parameters: List[ParameterDefinition],
  bodyBlock: ExprNode.BlockNode, override val position: Position
