...
const sum1 = Sum.type([Sum.type([Types.string, Types.number]), Types.boolean])
const sum2 = Sum.type([Types.string, Types.number, Types.boolean])
const sum3 = Sum.type([Types.string, Types.number, Types.boolean])
const intersection1 = Intersection.type([Types.string, Types.number, Types.boolean])
const intersection2 = Intersection.type([Types.boolean, Types.string, Types.number])
const intersection3 = Intersection.type([Types.string, Types.number, Types.boolean])
const list1 = Lists.type(Types.number)
const list2 = Lists.type(Types.number)
const list3 = Lists.type(Map.type(Types.string, Types.number))
const list4 = Lists.type(Map.type(Types.string, Types.number))
const tuple1 = Tuple.type([sum2, intersection1, list3])
const tuple2 = Tuple.type([sum2, intersection1, list3])
const tuple3 = Tuple.type([Sum.type([Types.string, Types.number, Types.boolean]), Intersection.type([Types.string, Types.number, Types.boolean]), Lists.type(Map.type(Types.string, Types.number))])
const tuple4 = Tuple.type([Sum.type([Types.string, Types.number, Types.boolean]), Intersection.type([Types.string, Types.number, Types.boolean]), Lists.type(Map.type(Types.string, Types.number))])
const shape1 = Shape.type({ x: Types.number, y: Types.number })
const shape2 = Shape.type({ x: Types.number, y: Types.number, c: Types.number, d: Types.string })
const shape3 = Shape.type({ d: Types.string, c: Types.number, x: Types.number, y: Types.number })
...
export function benchmarkAreEqual(): void {
  ...
  benchmark('basic types', () => areEqual(Types.number, Types.string), times)
...
export function benchmarkIsSubtype(): void {
  ...
  benchmark('not subtyped basic types', () => isSubtype(Types.number, Types.string), times)
